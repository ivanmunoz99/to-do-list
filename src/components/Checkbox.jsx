import React, { Fragment } from "react";//agrupar varios elementos sin añadirlos al DOM

// checkbox va a recibir parametros 
const Checkbox = props => {
    ...
    return (
        // <Fragment> no renderiza o no los agrega a la interfaz (al DOM) 
        <Fragment>
            <svg
                viewBox="0 0 0 0"
            ...
            <label className="todo new-item">
                {/* el input va recibir los parametros de checkbox */}
                <input
